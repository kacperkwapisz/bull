...
fn testing_strategy_names_scriptable_tools_for_bridge_gates() {
    ...
    let Some(strategy) = read_bull_file_opt("docs/testing-and-tooling-strategy.md") else {
        eprintln!(
