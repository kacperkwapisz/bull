...
struct LiveActivityContentView: View {
  ...
  @AppStorage("bull.swift.activity.lockHintSeen") private var lockHintSeen = false
  @AppStorage("bull.swift.activity.recentWorkouts") private var recentWorkoutRawValues = ""
