  ...
  private var content: some View {
    ...
    case .healthKit:
      OnboardingPermissionStep(
        ...
        title: "HealthKit",
        bodyText: "Bull uses HealthKit only to prefill profile values.",
        details: [
    ...
    case .location:
      OnboardingPermissionStep(
        ...
        title: "Location",
        bodyText: "Bull uses location to track outdoor workouts, routes, pace, and distance while an activity is running.",
        details: [
          "Active workout GPS while Bull is open",
          "Background route tracking when you minimize Bull",
    ...
    case .bluetooth:
      OnboardingPermissionStep(
        ...
        title: "Bluetooth",
        bodyText: "Bull needs Bluetooth to find your owned WHOOP strap and keep the local connection live.",
        details: [
    ...
    case .notifications:
      OnboardingPermissionStep(
        ...
        title: "Notifications",
        bodyText: "Bull can notify you when the strap connects, disconnects, or needs attention.",
        details: [
