...
extension BullBLEClient {
  ...
  func enqueueDisplayedMessage(_ message: BullMessage) {
  ...
  func appendDiagnosticLog(_ message: BullMessage) {
  ...
  static func recordDiagnosticLogSetupWarning(_ warning: String) {
    ...
    Logger(subsystem: "com.bull.swift", category: "ble")
  ...
  func writeConsoleDiagnosticLog(_ message: BullMessage) {
  ...
  func shouldDisplayMessage(_ message: BullMessage) -> Bool {
  ...
  func shouldWriteOSLog(_ message: BullMessage) -> Bool {
    if message.level == .warn || message.level == .error {
      return true
    }
    return !isHighVolumeDiagnostic(message)
  ...
  func isHighVolumeDiagnostic(_ message: BullMessage) -> Bool {
  ...
  func shouldPersistDiagnosticLog(_ message: BullMessage) -> Bool {
    if message.source == "ble.perf" {
      return true
    }
