...
extension BullAppModel {
  func recoverUncleanOvernightGuardSessionIfNeeded() {
    ...
    do {
      ...
      overnightGuardWarning = "Resumed previous overnight guard. Last heartbeat \(Self.overnightRecoveredStatusSummary(recovered)). Keep the official WHOOP app closed until Bull final sync/export finishes."
      ...
      overnightGuardWarning = "Previous overnight guard did not close cleanly; last heartbeat \(Self.overnightRecoveredStatusSummary(recovered)). Export Bull before opening the official WHOOP app."
