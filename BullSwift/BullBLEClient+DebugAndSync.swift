...
extension BullBLEClient {
  ...
  func completeDebugCommand(
    ...
    let response = BullDebugCommandResponse(
      id: UUID(),
  ...
  func debugCommandDefinitionPayload(_ command: BullDebugCommandDefinition) -> [String: Any] {
    [
      "id": command.id,
      "title": command.title,
  ...
  func debugCommandResponsePayload(_ response: BullDebugCommandResponse) -> [String: Any] {
    [
