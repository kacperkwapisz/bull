...
final class OvernightRawNotificationSpool: @unchecked Sendable {
  ...
  private let queue = DispatchQueue(label: "com.bull.swift.overnight-raw-spool", qos: .utility)
  ...
  func append(event: BullNotificationEvent, activeDeviceName: String, connectionState: String) -> OvernightRawSpoolSnapshot {
    queue.sync {
      ...
      var row: [String: Any] = [
        "schema": "bull.overnight.raw_notification.v2",
  ...
  func appendHistoricalRangeTelemetry(_ telemetry: BullHistoricalRangeTelemetry) -> OvernightRawSpoolSnapshot {
    queue.sync {
      ...
      let row: [String: Any] = [
        "schema": "bull.overnight.historical_range_poll.v1",
        "session_id": sessionID,
  ...
  func appendCommandWrite(_ event: BullCommandWriteEvent, activeDeviceName: String, connectionState: String) -> OvernightRawSpoolSnapshot {
    queue.sync {
      ...
      let row: [String: Any] = [
        "schema": "bull.overnight.command_write.v1",
        "session_id": sessionID,
  ...
  func appendEventLog(_ message: BullMessage) -> OvernightRawSpoolSnapshot {
    queue.sync {
      ...
      let row: [String: Any] = [
        "schema": "bull.overnight.event_log.v1",
        "session_id": sessionID,
  ...
  private func writeManifestLocked(status: String) throws {
    ...
    var manifest: [String: Any] = [
      "schema": "bull.overnight.manifest.v1",
      "session_id": sessionID,
      "status": status,
  ...
  private func writeCrashMarkerLocked(timestamp: String, statusLines: [String]) {
    ...
    let marker: [String: Any] = [
      "schema": "bull.overnight.crash_marker.v1",
      "session_id": sessionID ?? "none",
      "active": active,
  ...
  private func writeCheckpointLocked(
    ...
    var checkpoint: [String: Any] = [
      "schema": "bull.overnight.checkpoint.v1",
      "session_id": sessionID,
