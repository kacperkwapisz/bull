...
extension BullAppModel {
  ...
  static func captureEvidenceID(for frame: NotificationFrame, event: BullNotificationEvent, index: Int) -> String {
  ...
  func parseNotificationFrames(_ frames: [NotificationFrame], event: BullNotificationEvent) {
  ...
  func notificationParseContext(for event: BullNotificationEvent) -> NotificationParseContext {
  ...
  func handleParsedNotificationFrame(_ interpretation: NotificationFrameInterpretation, event: BullNotificationEvent) {
  ...
  struct CaptureFrameRowBuildRequest {
    ...
    let event: BullNotificationEvent
  ...
  func notificationIngestResult(for event: BullNotificationEvent) -> NotificationIngestResult {
    let reassembly = bullFrames(in: event.value, event: event)
  ...
  func bullFrames(in data: Data, event: BullNotificationEvent) -> FrameReassemblyResult {
  ...
  func frameReassemblyKey(for event: BullNotificationEvent) -> String {
