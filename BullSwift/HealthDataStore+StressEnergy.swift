...
extension HealthDataStore {
  func stressAlgorithmSummary(
    ...
    return StressAlgorithmSummary(
      ...
      source: .localEstimate("bull.stress.hr_proxy.v1 | confidence=\(confidenceText) | \(inputSummary)"),
  ...
  func energyBankAlgorithmSummary(
    ...
    return EnergyBankAlgorithmSummary(
      ...
      source: .localEstimate("bull.energy_bank.v1 | confidence=\(confidenceText) | \(inputSummary)"),
      freshness: stress.freshness,
