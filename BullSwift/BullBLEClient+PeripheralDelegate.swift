...
extension BullBLEClient: CBPeripheralDelegate {
  ...
  func fanOutNotification(_ event: BullNotificationEvent) {
    fanOutRawNotification(event)
    onNotification?(event)
  }

  func fanOutRawNotification(_ event: BullNotificationEvent) {
