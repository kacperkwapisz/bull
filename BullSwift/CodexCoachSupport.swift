...
enum CodexLocalToolContext {
  static func build(healthStore: HealthDataStore, appModel: BullAppModel) -> [String: Any] {
    [
  ...
  private static func getCaptureSessions(appModel: BullAppModel) -> [String: Any] {
    [
  ...
  private static func getRawSessionData(appModel: BullAppModel) -> [String: Any] {
    [
  ...
  private static func devicePayload(_ ble: BullBLEClient) -> [String: Any] {
    [
